...
function Nav() {
	...
	return (
		<motion.nav initial={false} className="menu">
			...
			>
				<motion.li variants={itemVariants}>Alla Filmer </motion.li>
				<motion.li variants={itemVariants}>Filmer </motion.li>
				<motion.li variants={itemVariants}>Specials </motion.li>
				<motion.li variants={itemVariants}>Dokumentärer </motion.li>
			</motion.ul>
			<motion.button
				whileTap={{ scale: 0.97 }}
			...
			>
				...
				<motion.li variants={itemVariants}>Releasedatum </motion.li>
